...
public:
                           ...
                           juce::Slider& slider) override
    {
        ...
        // ── 8. Pointer dot at tip
        {
            ...
            // glow halo
            g.setColour (Colour::CyanPrimary.withAlpha(0.4f));
                         ...
                         bool /*isDown*/) override
    {
        ...
        g.setColour (button.getToggleState() ? Colour::CyanPrimary : Colour::TextDim);
                       ...
                       juce::ComboBox& box) override
    {
        ...
        g.setColour (isButtonDown ? Colour::CyanPrimary : Colour::CyanDim);
        g.drawRoundedRectangle (bounds.reduced(0.5f), 4.0f, 1.0f);

        // chevron arrow
        const float arrowX = width - 16.0f;
        juce::Path arrow;
        arrow.startNewSubPath (arrowX,      height*0.4f);
        arrow.lineTo          (arrowX+5.0f, height*0.6f);
        arrow.lineTo          (arrowX+10.f, height*0.4f);
        g.setColour (Colour::CyanDim);
    ...
    //  LABEL
    // ─────────────────────────────────────────────────────────────
    juce::Font getLabelFont (juce::Label& lbl) override
    {
        return juce::Font ("Segoe UI", 9.0f, juce::Font::bold);
    }
